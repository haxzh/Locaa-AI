...
from core.email_handler import send_verification_email
...
def send_invite():
    ...
    try:
        ...
        role = data.get('role', 'member')  # admin, editor, viewer
        ...
        # send_team_invite_email(invite_email, user.first_name, token)
